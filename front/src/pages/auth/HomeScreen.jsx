    ...
    return (
        <>
            ...
            <div className="home-body">
                ...
                <h2 className="place"><span className="place"> {place ? place : "Carregando..."} </span> </h2>
                <p className="winner"><span className="winner">{winner ? `${winner.givenName} ${winner.familyName}` : "Carregando..."}</span> </p>
                <p className="team"><span className="team">{team ? `${team.name}` : "Carregando..."}</span></p>
            </div>
        </>
    );
};
